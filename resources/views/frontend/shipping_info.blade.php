                                        ...
                                        <label class="aiz-megabox d-block bg-white mb-0">
                                            ...
                                            <span class="d-flex p-3 aiz-megabox-elem">
                                                ...
                                                <span class="flex-grow-1 pl-3 text-left">
                                                    ...
                                                    <div>
                                                        <span class="opacity-60">{{ translate('Province') }}:</span>
                                                        <span class="fw-600 ml-2">{{ $address->province }}</span>
                                                    </div>
                                                    <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-feedback">
                                            <label class="control-label">{{ translate('Select your province')}}</label>
