                                        ...
                                        <div class="border p-3 pr-5 rounded mb-3 position-relative">
                                            ...
                                            <div class="dropdown position-absolute right-0 top-0">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    {{-- <a class="dropdown-item" onclick="edit_address()">{{ translate('Edit') }}</a> --}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
{{-- edit address modal --}}
{{-- <div class="modal fade" id="edit-address-modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-zoom" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">{{ translate('New Address')}}</h6>
