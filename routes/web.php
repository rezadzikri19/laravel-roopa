...
Route::get('/hohoho', function(){
	...
	$ongkir = $ongkir->setCouriers(['jne','tiki','pos'])->setOrigin(5)->setDestination(4)->setWeight(1000)->cost()->get();
	dd($ongkir);
});
...
Route::get('/province/{province_id}/cities', 'CityController@getCities');
